...
from crawler.products.models import SpProductAdReport


async def crawl_product_ad_report(client: SponsoredProductsClient, profile_id, report_date: str) -> None:
